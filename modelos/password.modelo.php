                    ...
                    <table style="background-size:100% 100%;height:800px;width:600px" border="0" cellspacing="0" cellpadding="20" background="http://www.integradoor.com/Test/vistas/img/iregistro1.jpeg">
                        <tr>
                            <td>
                                ...
                                <h4 class="h4-name">Haga click en el siguiente enlace para cambiar contraseña:<a href="http://integradoor.com/app/change?token='.$token.'">http://integradoor.com/app/change?token='.$token.'</a></h4>
                            </td>
                        </tr>

...
<b style="color:white; font-family:dejavusanscondensedbi; font-size:20px;">SEGURO VEHICULOS UTILITARIOS</b>
...
<table style="width:100% !important;" class="second" cellpadding="2"  border="0">';
...
foreach ($resultados as $resultado) {
	...
	if ($cont19 % 2 == 0) {
		if ($rowRespuestaAsistencia15['AsistenciaViajes'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:6pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . ($rowRespuestaAsistencia14['AsistenciaViajes'] == '' ? 'No cubre' : $rowRespuestaAsistencia15['AsistenciaViajes']) . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia15['AsistenciaViajes'] == "Si ampara") {
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:5pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
...
foreach ($resultados as $resultado) {
	...
	if ($cont22 % 2 == 0) {
		if ($rowRespuestaAsistencia17['LucroCesante'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:4pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . ($rowRespuestaAsistencia17['LucroCesante'] == '' ? 'No cubre' : $rowRespuestaAsistencia17['LucroCesante']) . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia17['LucroCesante'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:4pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . ($rowRespuestaAsistencia17['LucroCesante'] == '' ? 'No cubre' : $rowRespuestaAsistencia17['LucroCesante']) . '</font></center></td>';
		}
	}

...
===============================================================================================================*/
    $("#safGenNat").click (()=> 
    {
        ...
        if(permisoValidado){
            window.open('./vistas/modulos/AyudaVentas/pdf/sarlaft/15_Sarlaft_Generico.pdf');
        }else{
           mostrarAlerta();
        }
    })
...
===============================================================================================================*/    
    $("#safGenJur").click (()=> 
    {
        permisoValidado = validarPermiso(permisos.Descargarsarlaftpdfgenericos);
        if(permisoValidado){
            window.open('./vistas/modulos/AyudaVentas/pdf/sarlaft2/15_Sarlaft_Generico2.pdf');
        }else{
           mostrarAlerta();
        }
    })

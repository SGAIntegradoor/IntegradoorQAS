    ...
    success: function (data) {
                ...
                <table class="table table-bordered table-striped dt-responsives tablas" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="font-weight: bold; text-align: center;">Identificación</th>
                            <th style="font-weight: bold; text-align: center;">Razón social</th>
                            <th style="font-weight: bold; text-align: center;">Representante legal</th>
                            <th style="font-weight: bold; text-align: center;">Celular</th>
                            <th style="font-weight: bold; text-align: center;">Correo Electronico</th>
      ...
      data.forEach(function (item) {
        ...
        if (item.intermediario_Estado == 0) {
          contenido += `<td style="text-align: center;"><button class="btn btn-success btn-xs btnActivar" onclick="cambiarEst(${item.id_Intermediario}, ${item.intermediario_Estado}, 1)">Activo</button></td>`;
        } else {
          contenido += `<td style="text-align: center;"><button class="btn btn-danger btn-xs btnActivar" onclick="cambiarEst(${item.id_Intermediario}, ${item.intermediario_Estado}, 0)">Bloqueado</button></td>`;
        }
      ...
      // Después de cargar la tabla, inicializar DataTables
...
function cambiarEst(id, estado, variable) {
  Swal.fire({
    title:
      "¡Por favor confirma si quieres cambiar estado de este Intermediario!",
...
function traerCredenciales(id) {
  $.ajax({
    ...
    success: function (data) {
      ...
      $(".previsualizar_update").attr(
        "src",
        "vistas/img/logosIntermediario/" + data[0].urlLogo
      );
...
function actualizarInfoInter(id) {
  ...
  let numero_identificacionInter_update = $(
    "#numero_identificacionInter_update"
  ).val();
  ...
  let numero_identificacion_repre_update = $(
    "#numero_identificacion_repre_update"
  ).val();
  ...
  if (
    ...
    formData.append(
      "numero_identificacionInter_update",
      $("#numero_identificacionInter_update").val()
    );
    ...
    formData.append(
      "numero_identificacion_repre_update",
      $("#numero_identificacion_repre_update").val()
    );
    ...
    formData.append(
      "codigodistriaxa_update",
      $("#codigodistriaxa_update").val()
    );
...
function guardarinter() {
  ...
  let numero_identificacionInter_register = $(
    "#numero_identificacionInter_register"
  ).val();
  ...
  let numero_identificacion_repre_register = $(
    "#numero_identificacion_repre_register"
  ).val();
  let cel_register = $("#cel_register").val();

  if (
    tip_doc_register == 2 &&
    numero_identificacionInter_register.length != 9
  ) {
    swal.fire({
      type: "info",
    ...
    if (
      ...
      formData.append(
        "numero_identificacion_repre_register",
        $("#numero_identificacion_repre_register").val()
      );
      ...
      formData.append(
        "claveparaSura_register",
        $("#claveparaSura_register").val()
      );
      formData.append(
        "contraseñaAlli_register",
        $("#contraseñaAlli_register").val()
      );
      formData.append("idPartAlli_register", $("#idPartAlli_register").val());
      formData.append("idagentAlli_register", $("#idagentAlli_register").val());
      formData.append(
        "codigoPartAlli_register",
        $("#codigoPartAlli_register").val()
      );
      formData.append(
        "codigoagenAlli_register",
        $("#codigoagenAlli_register").val()
      );
      ...
      formData.append(
        "contraseñaEqui_register",
        $("#contraseñaEqui_register").val()
      );
      ...
      formData.append(
        "codigoAgeSoli_register",
        $("#codigoAgeSoli_register").val()
      );
      formData.append(
        "codPunVenSoli_register",
        $("#codPunVenSoli_register").val()
      );
      formData.append(
        "grantTypeSoli_register",
        $("#grantTypeSoli_register").val()
      );
      formData.append("cookieSoli_register", $("#cookieSoli_register").val());
      formData.append(
        "cookieToLibe_register",
        $("#cookieToLibe_register").val()
      );
      formData.append(
        "cookieReLibe_register",
        $("#cookieReLibe_register").val()
      );
      formData.append("autoLibe_register", $("#autoLibe_register").val());
      formData.append(
        "codigoAgenLibe_register",
        $("#codigoAgenLibe_register").val()
      );
      ...
      formData.append(
        "contraseñaaxa_register",
        $("#contraseñaaxa_register").val()
      );
      formData.append(
        "codigodistriaxa_register",
        $("#codigodistriaxa_register").val()
      );
      formData.append(
        "tipdistriaxa_register",
        $("#tipdistriaxa_register").val()
      );
      ...
      formData.append(
        "codigoagenhdi_register",
        $("#codigoagenhdi_register").val()
      );
      formData.append("usuhdi_register", $("#usuhdi_register").val());
      formData.append(
        "contraseñahdi_register",
        $("#contraseñahdi_register").val()
      );
      formData.append("ususbs_register", $("#ususbs_register").val());
      formData.append(
        "contraseñasbs_register",
        $("#contraseñasbs_register").val()
      );
      formData.append("usuzur_register", $("#usuzur_register").val());
      formData.append(
        "contraseñazur_register",
        $("#contraseñazur_register").val()
      );

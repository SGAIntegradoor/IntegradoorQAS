                    ...
                    <div class="card-ofertas">
                        <div class="row card-body">
                            <div class="col-xs-12 col-sm-6 col-md-2 oferta-logo" style="padding-top: 50px;">
                                ...
                                <center>
                                      <label class='entidad'>N° Cot: <span style='color:black'>11111</span></label>
                                </center>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-2 oferta-headerEdit" style="padding-top: 50px;">
                                <h5 class="entidad" style="font-size: 15px"><b>SBS - Hogareña</b></h5>
                                <h5 class="precio">Desde $ 500.000 COP</h5>

    ...
    <div class="content">
        ...
        <div class="col-md-4 col-sm-12 mb-3">
            <div class="card-exequias special-card">
                <div class="card-body">
                    <h4 class="card-title">¿Por qué ofrecer el Seguro de salud a tus
                        clientes?</h4>
                    ...
                    <p class="card-text">
                        Los Seguros o Pólizas de Salud son soluciones complementarias al sistema público, que ofrecen
                        diferentes programas y servicios para cuidar la salud de las personas, facilitandoles el acceso
                        a servicios médicos con los mejores profesionales e instituciones de salud del país y el
                        mundo.<br></p>
                    <p class="card-text">
        ...
        <div class="col-md-4 col-sm-12 mb-3">
            <div class="card-exequias">
                <div class="card-body">
                    <h4 class="card-title">¿Con qué aseguradora y cuáles son los tiempos de
                        repuesta?</h4>
        ...
        <div class="col-md-4 col-sm-12 mb-3">
            <div class="card-exequias">
                <div class="card-body">
                    <h4 class="card-title">¿Cuáles son las principales coberturas del Seguro
                        de Salud?</h4>
            ...
            <div class="card-exequias">
                <div class="card-body">
                    <h4 class="card-title">¿Qué datos y documentos se requieren para cotizar
                        y emitir?</h4>
                    <p class="card-text "><b>Cotización:</b> datos del contratante y beneficiarios<br></p>
                    <ul class="card-text ul-card">
                    ...
                    <p class="card-text "><b>Emisión:</b> es necesario ampliar la información y entregar la siguiente
                        documentación para <b>nuevas afiliaciones:</b> <br></p>
                    <ul class="card-text ul-card">

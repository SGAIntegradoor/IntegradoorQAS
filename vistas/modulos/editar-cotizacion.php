                ...
                <div class="col-lg-12 form-resumVeh">
                  <div class="row">
                    ...
                    <div class="">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-3 form-group" id="divTieneGasRetoma" style="display: none;">
                        <div style="display: flex; flex-direction: column; gap: 10px;">
                          <label for="tieneGasRadioRetoma">¿El taxi tiene sistema de gas?</label>
                          <div style="display: flex; flex-direction: row; align-items: center; gap: 20px">
                            <div style="display: flex; gap: 5px;">
                              <input type="radio" name="tieneGasRadioRetoma" id="tieneGasSiRetoma" value="Si" style="margin-top: 0px;"> Si
                            </div>
                            <div style="display: flex; gap: 5px;">
                              <input type="radio" name="tieneGasRadioRetoma" id="tieneGasNoRetoma" value="No" style="margin-top: 0px;"> No
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-sm-6 col-md-3 form-group" id="divGasDeFabricaRetoma" style="display: none;">
                        <div style="display: flex; flex-direction: column; gap: 10px;">
                          <label for="gasDeFabricaRetoma">¿El sistema de gas es de fábrica?</label>
                          <div style="display: flex; flex-direction: row; align-items: center; gap: 20px">
                            <div style="display: flex; gap: 5px;">
                              <input type="radio" name="gasDeFabricaRadioRetoma" id="gasDeFabricaSiRetoma" value="Si" style="margin-top: 0px;"> Si
                            </div>
                            <div style="display: flex; gap: 5px;">
                              <input type="radio" name="gasDeFabricaRadioRetoma" id="gasDeFabricaNoRetoma" value="No" style="margin-top: 0px;"> No
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                if ($idIntermediario != 78 && $idIntermediario != 4) {
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <p>El Valor asegurado máximo de acuerdo a la aseguradora es el siguiente: Seguros Mundial 700 millones. AXA Colpatria 400 millones. Previsora 700 millones. HDI 700 millones y 200 millones para remolques</p>
                      <p>

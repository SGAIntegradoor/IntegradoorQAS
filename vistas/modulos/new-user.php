            ...
            <div id="boxesInfoPerfil">
              <div class="" style="margin-bottom: 15px; display:flex; flex-direction: row; gap: 40px; align-content:flex-start">
                <div class="col-md-3" style="display:flex; flex-direction:column; padding-left: 0px !important;">
                  ...
                  <select type="text" name="unidadDeNegocio" id="unidadDeNegocio"> </select>
                </div>
                <div class="col-md-3" style="display:flex; flex-direction:column; padding-left: 0px !important;">
                  <label for="tipoDePersona"><b>Tipo de persona</b></label>
                  <select type="text" name="tipoDePersona" id="tipoDePersona"> </select>
                </div>
                <div class="col-md-3" style="display:flex; flex-direction:column; padding-left: 0px !important;">
                  <label for="tipoDocumento"><b>Tipo de documento</b></label>
                  <select type="text" name="tipoDocumento" id="tipoDocumento"> </select>
                </div>
                <div class="col-md-3" style="display:flex; flex-direction:column; padding-left: 0px !important;">
              ...
              <div class="" style="margin-bottom: 15px; display:flex; flex-direction: row; gap: 40px; align-content:flex-start;">
                ...
                <div class="col-md-3" style="display:flex; flex-direction:column; padding-left: 0px !important;">
                  <label for="nombres"><b>¿ Es el mismo representante legal ?</b></label>
                  <div class="" style="display:flex; flex-direction:row; padding-left: 0px !important; gap: 70px;">
                    <div style="display:flex; flex-direction:row; padding-left: 0px !important; align-items: center; gap: 10px;">
                      <input type="radio" name="radioRepresentante" id="siRepresentante" style="margin: 0px !important;">
                      <p style="margin: 0px !important;">Si</p>
                    </div>
                    <div style="display:flex; flex-direction:row; padding-left: 0px !important; align-items: center; gap: 10px;">
                      <input type="radio" name="radioRepresentante" id="noRepresentante" style="margin: 0px !important;">
                      <p style="margin: 0px !important;">No</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3" style="display:flex; flex-direction:column; padding-left: 0px !important;">
              ...
              <div class="" style="margin-bottom: 15px; display:flex; flex-direction: row; gap: 40px; align-content:flex-start; display: none;">
                <div class="col-md-3" style="display:flex; flex-direction:column; padding-left: 0px !important;">
                  <label for="razonSocial"><b>Razón Social</b></label>
                  <input type="text" name="razonSocial" id="razonSocial">
                </div>
              ...
              <div class="col-md-3" style="display:flex; flex-direction:column; padding-left: 0px !important;">
                ...
                <input type="text" name="departamento" id="departamento_perfil">
              </div>
              <div class="col-md-3" style="display:flex; flex-direction:column; padding-left: 0px !important;">
              ...
              <div class="col-md-3" style="display:flex; flex-direction:column; padding-left: 0px !important;">
                ...
                <input type="text" name="intermediario" id="intermediario">
              </div>
              <!-- </div> -->

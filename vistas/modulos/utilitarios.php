...
// if ($aseguradoras_utilitarios['SBS']['C'] == "1") {
...
// Lógica para ALLIANZ
if ($aseguradoras_utilitarios['Allianz']['C'] == "1") {
...
// Lógica para ESTADO
if ($aseguradoras_utilitarios['Estado']['C'] == "1") {
...
// Lógica para AXA
if ($aseguradoras_utilitarios['AXA']['C'] == "1") {
...
if ($aseguradoras_utilitarios['Solidaria']['C'] == "1") {
...
if ($aseguradoras_utilitarios['Previsora']['C'] == "1") {
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            Cotizar Seguro Autos Livianos Utilitarios de Trabajo
            ...
            <div class="box-body">
                <div id="formularioResumen">
                    ...
                    <div style="display: none;">
                        ...
                        <input type="hidden" name="aseguradoras" id="aseguradoras" value='<?php echo json_encode($aseguradoras_utilitarios); ?>'>
...
<script src="./vistas/modulos/Utilitarios/js/cotizarUtilitarios.js?v=<?php echo (rand()); ?>"></script>

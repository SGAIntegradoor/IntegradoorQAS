<?php
if ($_SESSION["rol"] != 12 && $_SESSION["rol"] != 10 && $_SESSION['rol'] != 1 && $_SESSION['rol'] != 22) {
  echo '<script>
...
<div class="content-wrapper">
  <section class="content-header">
    ...
    Consulta de cotizaciones y negocios nuevos
  ...
  <section class="content">
    <div class="box">
      <?php include_once './vistas/modulos/Productividad/views/productividad.php'; ?>
    </div>
  </section>
</div>
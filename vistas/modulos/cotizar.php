                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 form-group" id="nombreCompleto">
                      ...
                      <div id="digitoVerificacion" class="row" style="display: none">
                        <div id="divDigitoVerif" class="col-xs-12 col-sm-6 col-md-12 nomAseg">
                          <input type="text" class="form-control" id="txtDigitoVerif" placeholder="Digito de Verificación" required>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-lg-12 form-resumAseg">
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-3 form-group" id="tipoDocumento">
                      ...
                      <input type="hidden" class="form-control" id="cotRestanv" value="<?php echo $_SESSION["cotRestantes"]; ?>">
                      <label for="tipoDocumentoID">Tipo de Documento</label>
                      <select class="form-control" id="tipoDocumentoIDRepresentante" required>
                        <option value="" disabled selected>Selecciona el tipo de documento</option>
                        <option value="1">Cedula de ciudadania</option>
                        <option value="3">Cédula de extranjería</option>
                        <option value="4">Tarjeta de identidad</option>
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-3 form-group" id="fechaNacimiento">
                      ...
                      <div div id="fechaCompletaRepresentante" class="row">
                        <div class="col-xs-4 col-sm-4 col-md-4 conten-dia">
                          <select class="form-control fecha-nacimiento" name="dianacimientoRepresentante" id="dianacimientoRepresentante" required>
                            <option value="">Dia</option>
                            <?php
                            for ($i = 1; $i <= 31; $i++) {
                              if (strlen($i) == 1) { ?>
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 conten-mes">
                          <select class="form-control fecha-nacimiento" name="mesnacimientoRepresentante" id="mesnacimientoRepresentante" required>
                            <option value="" selected>Mes</option>
                            <option value="01">Enero</option>
                            <option value="02">Febrero</option>
                            <option value="03">Marzo</option>
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 conten-anio">
                          <select class="form-control fecha-nacimiento" name="anionacimientoRepresentante" id="anionacimientoRepresentante" required>
                            <option value="">Año</option>
                            <?php
                            for ($j = 1920; $j <= 2021; $j++) {
                            ?>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 form-group" id="genero">
                      ...
                      <select class="form-control" id="generoRepresentante" required>
                        <option value="" selected>Género</option>
                        <option value="1">Masculino</option>
                        <option value="2">Femenino</option>
                      </select>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 form-group" id="estadoCivil">
                      ...
                      <select class="form-control" id="estadoCivilRepresentante" required>
                        <option value="" selected>Estado Civil</option>
                        <option value="1">Soltero (a)</option>
                        <option value="2">Casado (a)</option>
                        <option value="3">Viudo (a)</option>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 form-group" id="correo">
                      <label for="correoRepresentante">Correo</label>
                      <input type="text" class="form-control" id="txtCorreoRepresentante" placeholder="Correo">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-3 form-group" id="celular">
                      <label for="celularRepresentante">Celular</label>
                      <input type="text" class="form-control" id="txtCelularRepresentante" placeholder="Celular">
                    </div>

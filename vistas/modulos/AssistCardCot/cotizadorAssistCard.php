    ...
    <?php } else {?>
        <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3" >
                    <div class="form-group">
                        <label for="nombreProspectoResumen">Nombre viajero principal</label>
                        <div class="row">
                            <div class="col-xs-12">
                                <input type="text" class="form-control" name="nombres" id="nombreProspectoResumen" placeholder="Nombre viajero principal" required <?php echo $editarCotizacion ? "disabled" : ""?>>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 col-md-4 conten-dia">
                                <select class="form-control fecha-nacimiento" name="dianacimiento" id="dianacimientoResumen" required disabled>
                                    <option value="">Dia</option>
                                    <?php
                                    for ($i = 1; $i <= 31; $i++) {
                                        if (strlen($i) == 1) { ?>
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 conten-mes">
                                <select class="form-control fecha-nacimiento" name="mesnacimiento" id="mesnacimientoResumen" required disabled>
                                    <option value="" selected>Mes</option>
                                    <option value="01">Enero</option>
                                    <option value="02">Febrero</option>
                                    <option value="03">Marzo</option>
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4 conten-anio">
                                <select class="form-control fecha-nacimiento" name="anionacimiento" id="anionacimientoResumen" required disabled>
                                    <option value="">Año</option>
                                    <?php
                                    for ($j = 1920; $j <= 2024; $j++) {
                                    ?>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="form-group">
                        <label for="lugarOrigen">Lugar de origen</label>
                        <select id="lugarOrigenResumen" class="form-control" disabled></select>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="form-group">
                        <label for="lugarDestino">Lugar de destino</label>
                        <select id="lugarDestinoResumen" class="form-control" disabled></select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="form-group">
                        <label for="fechaSalida">Fecha de salida</label>
                        <input type="date" id="fechaSalidaResumen" name="fechaSalida" class="form-control" disabled>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="form-group">
                        <label for="fechaRegreso">Fecha de regreso</label>
                        <input type="date" id="fechaRegresoResumen" name="fechaRegreso" class="form-control" disabled>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="form-group">
                        <label for="motivoViaje">Motivo de viaje</label>
                        <select id="motivoViajeResumen" class="form-control" disabled></select>
                    </div>
                </div>
    ...
    <div class="container-fluid" id="containerCardsResum">
        <div class="col-lg-12">
            <div class="row row-aseg">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <label for="">PARRILLA DE COTIZACIONES</label>

       ...
       <table class="table table-bordered table-striped dt-responsive tablas-assistcard" width="100%">
        ...
        <thead>
         ...
         <tr>
           ...
           <th style="font-weight: bold; text-align: center;">Fecha Nacimiento</th>
...
<script src="vistas\modulos\AssistCardCot\js\adminCotizacionesAssistCard.js?v=<?php echo (rand()); ?>"></script>
...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO comentarios_usuarios (id_comentario, modulo, id_general, comentario, fecha_comentario, id_user_comentario, nombre_usuario_comentario) VALUES (NULL, :modulo, :id_usuario, :comentario, NOW(), :id_user_comentario, :nombre_usuario_comentario)");
    ...
    if ($stmt->execute()) {
        ...
        echo json_encode(["status" => "error", "message" => "Error al guardar el comentario", "sqlError" => $stmt->errorInfo()], JSON_UNESCAPED_UNICODE);
    }
